...
export default function RegisterPage() {
  ...
  const handleSocialRegister = (provider: string) => {
    toast({
      ...
      description: `L'inscription via ${provider} n'est pas encore disponible. Utilisez votre email et mot de passe.`,
      variant: 'destructive',
    });
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (data) {
      ...
      toast({
        ...
        description: 'Configurons maintenant votre quincaillerie...',
      });
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              Commencez à gérer votre quincaillerie en quelques minutes
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {/* Social register buttons - disabled for now */}
